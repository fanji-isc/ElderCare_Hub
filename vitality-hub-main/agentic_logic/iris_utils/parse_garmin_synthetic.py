...
# TODO: sort loop logic
def get_ecgdata(end_datetime: datetime, sql_query: str = "SELECT TOP 7 JSON_ARRAYAGG(ECGData) FROM MyApp.JSONParsed ORDER BY CreatedAt DESC"):
    """
    ...
    iris_cursor.execute(sql_query + f" WHERE CreatedAt <= {end_datetime}")
...
# TODO: sort loop logic
def get_hrdata(end_datetime: datetime, sql_query: str = "SELECT TOP 7 JSON_ARRAYAGG(HRData) FROM MyApp.JSONParsed ORDER BY CreatedAt DESC"):
    """
...
# TODO: sort loop logic
def get_sleepdata(end_datetime: datetime, sql_query: str = "SELECT TOP 7 JSON_ARRAYAGG(SleepData) FROM MyApp.JSONParsed ORDER BY CreatedAt DESC"):
    """
