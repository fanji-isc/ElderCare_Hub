...
import { Heart, Moon, Footprints, Activity, Upload, Stethoscope } from "lucide-react";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const heartRate = Number(latestDay?.currentDayRestingHeartRate ?? latestDay?.restingHeartRate ?? 0);
      ...
      <div className="border-b border-border bg-card/40">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-display-sm font-display text-foreground">Patient: Frank</h2>
            </div>
